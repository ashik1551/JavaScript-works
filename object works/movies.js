...
// var fil=filims.filter(o1=>Number(o1.runtime)<130);
// console.log(fil.map(o1=>o1.title));

// var fil=filims.reduce((o1,o2)=>Number(o1.runtime)>Number(o2.runtime)?o1:o2)
// console.log(fil.title);

// var fil=filims.reduce((o1,o2)=>Number(o1.runtime)<Number(o2.runtime)?o1:o2)
// console.log(fil.title);

// var years={}
// filims.map(o1=>o1.year in years?years[o1.year]+=1:years[o1.year]=1)
// console.table(years);

// var fil=filims.filter(o1=>o1.genres.includes('Action'))
// console.log(fil.map(o1=>o1.title));

// var fil=filims.filter(o1=>o1.genres.includes('Action'||'Drama'))
// console.log(fil);

// var years={}
// filims.map(o1=>o1.year in years?years[o1.year]+=1:years[o1.year]=1)
// years=Object.entries(years)
// console.log(years.reduce((o1,o2)=>o1[1]>o2[1]?o1:o2));