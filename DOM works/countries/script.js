...
function displayCountry(countries){
  ...
  for(let c of countries){
    htmldata+=`<div class="relative aspect-[16/9]  w-auto rounded-md md:aspect-auto md:h-[400px]">
            <img src="${c.flag}"
                alt="AirMax Pro" class="z-0 h-full w-full rounded-md object-cover" />
...
function populateName(){
  let choice=countries.map(c=>c.name)
  console.log(choice);
  for(let c of choice){
    let optiontag=document.createElement('option')
    optiontag.value=c
    optiontag.text=c
    document.querySelector("#drop").appendChild(optiontag)
  }
}
...
function countryDetail(event){
  ...
  document.querySelector("#detail").innerHTML=`<div class="mx-auto max-w-5xl px-5 py-24">
            <div class="mx-auto flex flex-wrap items-center lg:w-4/5">
                <img alt="..." class="h-64 w-full rounded object-cover lg:h-96 lg:w-1/2"
                    src="${country[0].flag}" />
                <div class="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
                    <h2 class="text-sm font-semibold tracking-widest text-gray-500">
                    ${country[0].region}
                    </h2>
                    <h1 class="my-4 text-3xl font-semibold text-black">${country[0].name}</h1>
                    ...
                    <div class="mb-5 mt-6 flex items-center border-b-2 border-gray-100 pb-5">
                        <div class="flex items-center">
                            <span class="mr-3 text-sm font-semibold">Time Zone : ${country[0].timezones}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="mr-3 text-sm font-semibold">Demonym : ${country[0].demonym}</span>
                        </div>
                        <div class="ml-auto flex items-center">
                            <span class="mr-3 text-sm font-semibold">Native name : ${country[0].nativeName}</span>
